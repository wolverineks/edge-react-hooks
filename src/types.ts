...
type CallbackRemover = () => unknown
type Subscriber<Events> = (name: keyof Events, callback: (value: Events[typeof name]) => any) => CallbackRemover
 ...
 */
export type EdgeFetchFunction = (uri: string, opts?: EdgeFetchOptions) => Promise<EdgeFetchResponse>
...
export type EdgeCorePlugin = EdgeCurrencyPlugin | EdgeRatePlugin | EdgeSwapPlugin

type EdgeCorePluginFactory = (env: EdgeCorePluginOptions) => EdgeCorePlugin

export type EdgeCorePlugins = EdgePluginMap<EdgeCorePlugin | EdgeCorePluginFactory>
...
export type EdgeFakeWorld = {
  ...
  makeEdgeContext(opts: EdgeContextOptions & { cleanDevice?: boolean }): Promise<EdgeContext>
...
export type EdgeCreatePrivateKeyOptions = EdgeBitcoinPrivateKeyOptions | JsonObject

...
type WRITE_FIAT_CURRENCY_CODE_SUCCESS = {| type: "WRITE_FIAT_CURRENCY_CODE_SUCCESS", fiatCurrencyCode: string |};
type WRITE_FIAT_CURRENCY_CODE_ERROR = {| type: "WRITE_FIAT_CURRENCY_CODE_ERROR", error: Error |};
type READ_FIAT_CURRENCY_CODE_SUCCESS = {| type: "READ_FIAT_CURRENCY_CODE_SUCCESS", fiatCurrencyCode: string |};
type Action =
